...
CREATE TABLE IF NOT EXISTS `scripts` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci COMMENT='ehcp db - stores scripts that can be installed from within in ehcp, i.e, easy install scripts';
...
(1, 'cms - joomla 2.5', NULL, NULL, 'directurl', 'http://downloads.joomlacode.org/frsrelease/7/6/0/76012/Joomla_2.5.7-Stable-Full_Package.zip', '', 'cp /dev/null configuration.php\r\nchmod a+w configuration.php',''),
(2, 'cms - joomla 3.3.6 ', 'http://www.joomla.org', 'CMS', 'directurl', 'https://github.com/joomla/joomla-cms/releases/download/3.3.6/Joomla_3.3.6-Stable-Full_Package.zip', '', 'cp /dev/null configuration.php\r\nchmod a+w configuration.php', NULL),
...
(20, 'ecommerce-prestashop', NULL, NULL, 'directurl', 'http://www.prestashop.com/ajax/controller.php?method=download&type=releases&file=prestashop_1.6.0.9.zip&language=', 'prestashop', '',''),
...
(52, 'Roundcube', 'https://roundcube.net', 'Roundcube webmail software', 'directurl', 'https://github.com/roundcube/roundcubemail/releases/download/1.2.3/roundcubemail-1.2.3-complete.tar.gz', 'roundcubemail-1.2.3', 'chmod a+rw temp logs\r\n', NULL)
;
...
CREATE TABLE IF NOT EXISTS scripts_log (
  ...
  scriptname varchar(50) default NULL,
  dir text,
  panelusername varchar(100) default NULL,
  domainname varchar(100) default NULL,
  link varchar(200) default NULL,
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci  COMMENT='ehcp db - stores script install logs that are installed through ehcp easy install scripts';
...
CREATE TABLE IF NOT EXISTS servers (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci COMMENT='ehcp db - servers that are to be used with ehcp, multi server concept';
...
CREATE TABLE IF NOT EXISTS directories (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - password protected directories';
...
CREATE TABLE IF NOT EXISTS subdomains (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - subdomains';
...
CREATE TABLE IF NOT EXISTS customsettings (
  ...
  comment varchar(50) default NULL,
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - custom http, custom dns for domains';
...
CREATE TABLE alias (
  ...
  PRIMARY KEY  (address),
  KEY address (address)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci COMMENT='ehcp db - Postfix Admin - Virtual Aliases';
...
CREATE TABLE IF NOT EXISTS domains (
  ...
  ssl_certificate_file varchar(100) default "",
  ssl_certificate_key_file varchar(100) default "",
  PRIMARY KEY  (id),
  KEY domainname (domainname)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci  comment='ehcp db - list of domains and their properties';
...
CREATE TABLE IF NOT EXISTS emailusers (
  ...
  PRIMARY KEY  (id),
  KEY email (email)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci   COMMENT='ehcp db - email users of domains';
...
CREATE TABLE IF NOT EXISTS forwardings (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - email forwardings';
...
CREATE TABLE ftpaccounts (
  ...
  reseller varchar(100) default NULL,
  panelusername varchar(100) default NULL,
  homedir varchar(150) default NULL,
  status varchar(10) default NULL,
...
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - ftp accounts that are used in domains,ehcp,etc, used in vsftpd';
...
CREATE TABLE html (
  ...
  PRIMARY KEY  (id),
  KEY id (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - used in db style of templates, not used much now';
...
CREATE TABLE IF NOT EXISTS backups (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - list of backups done through ehcp gui';
...
CREATE TABLE log (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db -  some log entries, may not be used';
...
CREATE TABLE IF NOT EXISTS misc (
  ...
  PRIMARY KEY  (id),
  KEY `i_name` (`name`)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci COMMENT='ehcp db - Table for misc configruation of ehcp';
...
CREATE TABLE mysqldb (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - list of mysql databases, related to ehcp';
...
CREATE TABLE mysqlusers (
  ...
  password varchar(30) default NULL,
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - list of mysql users related to ehcp';
...
CREATE TABLE operations (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - list of pending/done daemon operations, misc operations.. ';
...
CREATE TABLE panelusers (
  ...
  comment varchar(100) default NULL,
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci comment='ehcp db - panel users, clients, resellers';
...
CREATE TABLE `net2ftp_log_access` (`id` int(10) unsigned NOT NULL auto_increment,`date` date NOT NULL default '0000-00-00',`time` time NOT NULL default '00:00:00',`remote_addr` text NOT NULL,`remote_port` text NOT NULL,`http_user_agent` text NOT NULL,`page` text NOT NULL,`datatransfer` int(10) unsigned default '0',`executiontime` mediumint(8) unsigned default '0',`ftpserver` text NOT NULL,`username` text NOT NULL,`state` text NOT NULL,`state2` text NOT NULL,`screen` text NOT NULL,`directory` text NOT NULL,`entry` text NOT NULL,`http_referer` text NOT NULL,KEY `index1` (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
DROP TABLE IF EXISTS `net2ftp_log_error`;
CREATE TABLE `net2ftp_log_error` (`date` date NOT NULL default '0000-00-00',`time` time NOT NULL default '00:00:00',`ftpserver` text NOT NULL,`username` text NOT NULL,`message` text NOT NULL,`backtrace` text NOT NULL,`state` text NOT NULL,`state2` text NOT NULL,`directory` text NOT NULL,`remote_addr` text NOT NULL,`remote_port` text NOT NULL,`http_user_agent` text NOT NULL,KEY `index1` (`date`,`time`,`ftpserver`(100),`username`(50))) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
DROP TABLE IF EXISTS `net2ftp_log_consumption_ftpserver`;
CREATE TABLE `net2ftp_log_consumption_ftpserver`(`date` date NOT NULL default '0000-00-00',`ftpserver` varchar(255) NOT NULL default '0',`datatransfer` int(10) unsigned default '0',`executiontime` mediumint(8) unsigned default '0',PRIMARY KEY  (`date`,`ftpserver`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
DROP TABLE IF EXISTS `net2ftp_log_consumption_ipaddress`;
CREATE TABLE `net2ftp_log_consumption_ipaddress`(`date` date NOT NULL default '0000-00-00',`ipaddress` varchar(15) NOT NULL default '0',`datatransfer` int(10) unsigned default '0',`executiontime` mediumint(8) unsigned default '0',PRIMARY KEY  (`date`,`ipaddress`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
DROP TABLE IF EXISTS `net2ftp_users`;
CREATE TABLE `net2ftp_users` (`ftpserver` varchar(255) NOT NULL default '0',`username` text NOT NULL,`homedirectory` text NOT NULL,KEY `index1` (`ftpserver`,`username`(50))) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
DROP TABLE IF EXISTS `net2ftp_log_status`;
CREATE TABLE `net2ftp_log_status` (`month` varchar(6) NOT NULL, `status` int(3) NOT NULL, `changelog` text NOT NULL, PRIMARY KEY (`month`)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;


# for future development of ehcp..
